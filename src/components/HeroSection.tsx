    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="container mx-auto px-4 pt-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 border border-primary-foreground/20 mb-6 animate-fade-in-up opacity-0"
          ...
          {/* Title */}
          <h1
            className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-primary-foreground mb-6 animate-fade-in-up opacity-0 animation-delay-200"
            style={{ animationFillMode: "forwards" }}
          >
            {title}
          </h1>
          ...
          {/* Description */}
          <p
            className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto animate-fade-in-up opacity-0 animation-delay-400"
            style={{ animationFillMode: "forwards" }}
          >
            {description}
          </p>
          ...
          {/* Actions */}
          <div
            className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up opacity-0 animation-delay-600"
            style={{ animationFillMode: "forwards" }}
          >
            {primaryAction && (
              <Link to={primaryAction.path}>
                <Button
                  size="lg"
                  className="bg-primary-foreground text-ieee-blue hover:bg-primary-foreground/90 gap-2 shadow-ieee-lg animate-pulse-glow"
                >
                  {primaryAction.label}
            ...
            {secondaryAction && (
              <Button
                ...
                onClick={() => {
                  if (secondaryAction.path.startsWith("#")) {
                    const id = secondaryAction.path.substring(1);
